...
- `backend/src/vision/ContourExtractionService.*`: Interactive contour extraction service. Reads Image Lab result previews, ranks quadrilateral contour candidates, exposes candidate metadata, runs selected-region OpenCV template OCR, and delegates selected perspective extraction to the Image Result processing pipeline.
